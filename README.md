...
1.7. When testing connection to the database is established use below commands to create a user named ```admin``` with the password ```12345678```, grant all privileges to that user on all databases and tables, and flush the privileges to ensure the changes take effect.
```sql
